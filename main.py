...
# @title Main Code
# @markdown <div><center><img src="https://github.com/SKMAXStudio/SKMAXStudioImages/assets/118368174/89ed6aab-110d-4bd1-be0b-1fad6c32fa79" height=50></center></div>

# @markdown <br><h3><b>🤖 Select The `Bot Mode` You want</b></h3>
        ...
        [
            [  # First row
                InlineKeyboardButton(  # Opens a web URL
                    "GitHub 🪲",
                    url="https://github.com/SKMAXStudio",
                ),
            ],
            [
                InlineKeyboardButton(  # Opens a web URL
                    "SKMAX Studio Official™",
                    url="https://t.me/SKMAX_Studio",
                ),
                InlineKeyboardButton(  # Opens a web URL
                    "Group 💬",
                    url="https://t.me/+oE4LvWgc9QRkZGFl",
                ),
            ],
        ]
    )
...
async def FinalStep(msg, is_leech: bool):
    ...
    l_ink = "⌬─────[「SKMAX Studio Official™ 」](https://www.youtube.com/@SKMAXStudioOfficial)─────⌬"
    ...
    if is_leech:
        try:
            ...
            Err += f"\n\n<i>⚠️ If You are Unknown with this **ERROR**, Then Forward This Message in [SKMAX Studio Official™ Discussion](https://t.me/+oE4LvWgc9QRkZGFl) Where [SKMAX Studio Official™](https://t.me/SKMAX_Studio) may fix it</i>"
            await bot.send_message(
...
try:
    ...
    Error_Text = (
        "⍟───── [SKMAX Studio Official™](https://www.youtube.com/@SKMAXStudioOfficial) ─────⍟\n"
